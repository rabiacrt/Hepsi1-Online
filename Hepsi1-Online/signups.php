  ...
  <div class="grid">
    ...
    <?php if (isset($_GET['error'])) { ?>
     	...
     	<?php } ?>
          ...
          <?php } ?>
      <div class="form__field" action="signup.php" method="POST">
      ...
      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">İsim</span></label>
        <input autocomplete="username" id="login__username" type="text" name="name" class="form__input" placeholder="İsim" required>
      </div>
      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
      ...
      <div class="form__field">
        <label for="login__password"><svg class="icon">
            <use xlink:href="#icon-lock"></use>
          </svg><span class="hidden">Tekrar Şifre</span></label>
        <input id="login__password" type="password" name="tpass" class="form__input" placeholder="Şifre (tekrar)" required>
      </div>
      <div class="form__field">
        <input type="submit" value="Kayıt Ol">
      </div>
        <p class="text--center">Giriş yapmak için? <a href="logins.php">Tıkla</a> <svg class="icon">
